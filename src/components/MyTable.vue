<template>
  <div class="table-show">
    <el-table :ref='tableData.ref' 
      :data="tableData.dataList" 
      :height="tableData.height"
      :row-key="tableData.rowKey || 'id'" 
      ...
      <el-table-column v-if='tableData.selection || false' type="selection" :selectable='tableData.selectable'
        :reserve-selection="tableData.reserveSelection || false" width="55">
      </el-table-column>
      <el-table-column v-if='!col.hide' v-for="(col, index) in tableData.columns" :key="index" :type="col.type"
        :show-overflow-tooltip='col.showTooltip' :sortable="col.sortable" :prop="col.prop" :fixed="col.fixed"
        :label="col.label" :align="col.align || 'center'" :width="col.width">
    ...
    <div class="page-list" :style='{"justifyContent":pageObj.justifyContent?pageObj.justifyContent:"center"}'
      v-if='pageShow'>
